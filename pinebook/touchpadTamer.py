# Touchpad Tamer python script posted by 'David' from the pine64 forums
# URL: https://forum.pine64.org/showthread.php?tid=4916&pid=30496#pid30496
#
# To use, first make sure user is in input group 
# (i.e. usermod -aG input <username>) then you could:
#    * run manually from the a terminal window using python3
#    * run from ~/.xprofile
#    * run on Mate via System -> Preferences -> Personal -> Startup Applications
#
# Suggested command line and path:
#    /usr/bin/python3 /usr/local/bin/touchpadTamer.py
